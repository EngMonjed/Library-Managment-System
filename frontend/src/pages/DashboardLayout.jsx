...
const NAV_ITEMS = [
  ...
  },
  {
    key: "categories",
    label: "التصنيفات",
    icon: <Grid className="w-5 h-5 shrink-0" />,
  },
  {
    key: "books",
    label: "الكتب",
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        className="w-5 h-5 shrink-0"
      >
        <path d="M16 3H1v18h15" />
        <path d="M8 21l8-9-8-9" />
      </svg>
    ),
  },
  {
...
const STATS = [
  ...
  { label: "العضويات النشطة", value: "1,093", change: "+8.1%", up: true },
  { label: "التسليمات المتأخرة", value: "47 يوم", change: "-12%", up: false },
  { label: "العضويات المعلقة", value: "25", change: "-5.4%", up: false },
...
export default function DashboardLayout({ onLogout }) {
  ...
  const activeLabel =
    NAV_ITEMS.find((n) => n.key === active)?.label ?? "الرئيسية";
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo row */}
        <div
          className={`flex items-center h-16 px-3 border-b border-slate-700/60 ${collapsed ? "justify-center" : "justify-between"}`}
        >
          {/* Brand */}
          <div
            className={`flex items-center gap-2.5 ${collapsed ? "" : "flex-row-reverse"}`}
          >
        ...
        <div
          className={`border-t border-slate-700/60 p-3 ${collapsed ? "flex justify-center" : ""}`}
        >
          <div
            className={`flex items-center gap-3 ${collapsed ? "" : "flex-row-reverse"}`}
          >
                ...
                {STATS.map((stat) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <span
                        className={`text-xs font-medium px-2 py-0.5 rounded-md ${stat.up ? "bg-emerald-50 text-emerald-600" : "bg-red-50 text-red-500"}`}
                      >
                        {stat.change}
                      </span>
